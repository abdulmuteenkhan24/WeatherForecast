...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //weatherRV = findViewById(R.id.idRvWeatherLabel);
...
//        weatherRV = findViewById(R.id.idRvWeather);
//        RecyclerView recyclerView = findViewById(R.id.idRvWeather);
//        recyclerView.setLayoutManager(new LinearLayoutManager(this));
//        weatherRV.setAdapter(weatherRVAdapter);


        weatherRVAdapter = new WeatherRVAdapter(this, weatherRVModalArrayList);
        RecyclerView recyclerView = weatherRV;
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        weatherRV.setAdapter(weatherRVAdapter);
    ...
    private void getWeatherInfo(String cityName) {
        String url = "https://api.weatherapi.com/v1/forecast.json?key=463b33f62b2f41c1ab4203520232110 &q=" + cityName + "&days=1&aqi=yes&alerts=yes";
